...
/**
 * Landing-page FAQ. Answers stay consistent with the rest of the site's
 * "honest, not oversold" tone (see the Trust section on this same page and
 * docs/JUDGE_QA.md) — no claims this product doesn't actually back up.
 */
const FAQS = [
  {

...
export default function LandingPage() {
  return (
    <div className="flex flex-1 flex-col bg-background">
      ...
      {/* Stats — real, verified facts about the actual build (see
          stats-band.tsx for how each number was checked), not invented
          usage metrics. */}
      <ScrollReveal>
        <StatsBand />
      </ScrollReveal>
      ...
      {/* Product preview — bigger than before, with a mini animated
          metric grid (grows in on scroll via the same [data-reveal]
          mechanism ScrollReveal already uses) instead of just the status
          row, so the "illustrative preview" actually shows the kind of
          signal detail the real dashboard surfaces. */}
      <ScrollReveal>
